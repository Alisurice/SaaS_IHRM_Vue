...
export const applyOvertime = data => createAPI('/user/process/startProcess', 'post', data)
export const applyDimission = data => createAPI('/user/process/startProcess', 'post', data)
export const applyeLave = data => createAPI('/user/process/startProcess', 'post', data)
